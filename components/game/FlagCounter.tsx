...
export interface FlagCounterProps {
    ...
    /**
     * bar: bare, larger type (desktop HUD); hud: bare, small type (mobile
     * sticky bar, daily row); dialog: boxed, "N left" (mobile players dialog).
     */
...
export default function FlagCounter({ remainingFlags, variant }: FlagCounterProps) {
    ...
    // The HUD setting hides the LIVE counter only; the dialog variant is a report.
